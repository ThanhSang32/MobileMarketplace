...
export const StarHalf = (props: React.SVGProps<SVGSVGElement>) => (
  <svg 
    ...
    {...props}
  >
    <path d="M12 17.8 5.8 21 7 14.1 2 9.3l7-1L12 2" fill="none" />
    <path d="M12 2v15.8l-3.2 1.7" />
    <path d="m22 9.3-7-1L12 2" fill="none" />
    <path d="M17 14.1 18.2 21l-6.2-3.2" fill="none" />
  </svg>
);
